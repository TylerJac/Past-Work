...
def display_cities_by_population_ascending():
    ...
    Returns:
        list: A list of tuples representing city information (CityID, CityName, Population).
    """
...
def display_total_population():
    ...
    Returns:
        float: Total population of all cities.
    """
    # Connect to the database
    conn = connect_to_database()
    # Create a cursor object to execute SQL queries
...
def display_average_population():
    ...
    Returns:
        float: Average population of all cities.
    """
    # Connect to the database
    conn = connect_to_database()
    # Create a cursor object to execute SQL queries
...
def display_city_with_highest_population():
    ...
    Returns:
        tuple: A tuple representing city information (CityID, CityName, Population).
    """
    # Connect to the database
    conn = connect_to_database()
    # Create a cursor object to execute SQL queries
    cursor = conn.cursor()
    # Execute SQL query to select all columns from the 'Cities' table, ordering the result by population in descending order, and limit the result to 1 row
...
def display_city_with_lowest_population():
    ...
    # Create a cursor object to execute SQL queries
    cursor = conn.cursor()
    # Execute SQL query to select all columns from the 'Cities' table, ordered by Population in ascending order, limiting the result to one row.
